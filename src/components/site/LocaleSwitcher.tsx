...
export function LocaleSwitcher({ locale, className }: LocaleSwitcherProps) {
  ...
  return (
    <a
      ...
      className={
        className ??
        "rounded-sm text-sm font-medium tracking-wide text-[var(--color-ink)]/70 underline-offset-4 transition-colors hover:text-[var(--color-ink)] hover:underline focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[var(--color-teal)] focus-visible:ring-offset-2 focus-visible:ring-offset-[var(--color-page)]"
      }
    >
      {label}
    </a>
